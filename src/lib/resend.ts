    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 40px 24px; background: #ECE6DD; color: #0D0D0D;">
        ...
        <div style="background: #E3DCD2; padding: 16px; margin-bottom: 24px; border-left: 3px solid #D4213D;">
          <div style="font-size: 14px; font-weight: 500;">${escapeHtml(riderName)}</div>
          <div style="font-family: monospace; font-size: 12px; color: #8A8279; margin-top: 4px;">${escapeHtml(location)}</div>
          ${message ? `<div style="font-size: 13px; margin-top: 8px; color: #0D0D0D; line-height: 1.5;">"${escapeHtml(message)}"</div>` : ''}
        </div>
    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 40px 24px; background: #ECE6DD; color: #0D0D0D;">
        ...
        <p style="font-size: 14px; line-height: 1.7; margin-bottom: 24px;">
          Hey ${escapeHtml(riderName)}, your photo has been approved and added to the TRACKID Rider Registry.
        </p>
        <div style="background: #E3DCD2; padding: 16px; margin-bottom: 24px; border-left: 3px solid #D4213D;">
